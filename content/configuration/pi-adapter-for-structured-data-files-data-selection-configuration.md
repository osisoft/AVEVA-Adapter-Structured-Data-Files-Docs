...
| **TimeFormat**| Optional | `string` | Time format of the timestamp specified in the **TimeField** parameter.<br><br>&bull; Default value: null.<br><br/>Example: `MM/dd/yyyy H:mm:ss zzz`.<br><br>**Note:** For more examples of time format syntax, see <xref:TextParser#date-and-time-processing>. |
