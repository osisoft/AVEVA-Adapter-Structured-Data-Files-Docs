...
| **TimeZone** | Optional | `string` | Time zone of timestamps in the input files. If specified, the value must be a valid entry from the IANA time zone database.<br><br>Example 1: `America/Los_Angeles`<br>Default value: `Etc/UTC` <br><br>Example 2: This example represents three `dates` and a `value` seperated by commas.<br><br>`Date1,Date2,Date3,Value`<br>`03-08-2020T02:59-05:00,03-08-2020T02:59,03-08-2020T02:59Z,12345.6789`<br><br>Date1 = `03-08-2020T02:59-05:00`<br>this date has a "-05:00" adjustment meaning the date will be UTC-5.<br><br>Date2 = `03-08-2020T02:59`<br>this date is displayed with no adjustment and will make use of the default timezone properly.<br><br>Date3 = `03-08-2020T02:59Z`<br>this date is displayed with a "Z" so will be UTC.<br><br>Value = `12345.6789` |
