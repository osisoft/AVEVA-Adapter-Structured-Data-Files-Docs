...
| **TimeField** | Required | `string` | Name of the time field. XPath and JsonPath are supported.  If no timestamp is provided in the file, the following values can be used to specify the timestamp:<br> - FileCreationTime - Time the file was created. <br> -  FileModifiedTime - Time the file was modified.<br> - AdapterGeneratedTime - Time the file is processed by the adapter. <br> Example: \"FanSpeedTimeStamp\"|
| **DataType** | Required | `string` | Data type of the values specified in the ValueField property.<br> Example: "Int32" <br> Allowed values: SByte, Byte, Int16, UInt16, Int32, UInt32, Int64, UInt64, Double, Decimal, Boolean, Char, String, DateTime|
